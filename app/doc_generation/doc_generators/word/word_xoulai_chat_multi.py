        ...
        if field_name == "xouls":
            ...
            if value:
                for idx, xoul in enumerate(value):
                    doc.add_heading(f"Xoul {idx + 1}", level=4) # TODO: change to use name, here and in single
            ...
            if value:
                for idx, persona in enumerate(value):
                    doc.add_heading(f"Persona {idx + 1}", level=4) # TODO: change to use name, here and in single
